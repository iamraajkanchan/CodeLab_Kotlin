...
class LinkyListImplementation {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            ...
            val linkyListImplementation = LinkyListImplementation()

            linkyListImplementation.testGetFirst()
            linkyListImplementation.testAddV2()
            linkyListImplementation.testGet()
            linkyListImplementation.testSet()
            linkyListImplementation.testRemoveFirst()
            linkyListImplementation.testRemoveLast()
            linkyListImplementation.testRemoveValue()
            linkyListImplementation.testAddAll()
        }
    }
}
